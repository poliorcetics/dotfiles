...
export module main {
    ...
    export module brew {
        export def casks [] {
            brew install --cask appcleaner db-browser-for-sqlite firefox kitty macs-fan-control monitorcontrol orbstack rectangle signal transmission tunnelblick vlc
